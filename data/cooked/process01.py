...
#print('NAME,COUNTRY,LATITUDE,LONGITUDE,ELEVATION,TYPE,POPULATION WITHIN 10KM,LARGEST YEAR,LARGEST VEI,LATEST YEAR,LATEST VEI')
    ...
    with open('eruptions.csv') as efile:
        ...
        for v in vf:
            ...
            if len(my_e) > 0:
                ...
                #    largest['START'], largest['VEI'], latest['START'], latest['VEI'] \
                #]]))
